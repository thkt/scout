...
| `escape_yaml`             | src/fetch/converter.rs:143-165 | `\` `"` `\n\r\t` を escape、`\0` を除去                                                  |
| `neutralize_yaml_markers` | src/fetch/converter.rs:112-131 | 行頭 `---`/`...` を `***` へ書き換え、indent/inline は不変                               |
